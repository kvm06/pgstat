# Generated by Django 4.1.4 on 2022-12-18 06:32
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('statcollector', '0002_bookings_tickets'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TicketFlights',
            fields=[
                ('ticket_no', models.OneToOneField(db_column='ticket_no', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='statcollector.tickets')),
        ...
        migrations.CreateModel(
            name='Seats',
            fields=[
                ('aircraft_code', models.OneToOneField(db_column='aircraft_code', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='statcollector.aircraftsdata')),
                ('seat_no', models.CharField(max_length=4)),
                ('fare_conditions', models.CharField(max_length=10)),
            ],
            options={
