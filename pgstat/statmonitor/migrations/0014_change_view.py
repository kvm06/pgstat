    ...
    operations = [
        migrations.RunSQL(
            ...
            SELECT a.id AS stat_id,
                date_trunc('minute'::text, a.datecr) AS query_minute,
                date_trunc('hour'::text, a.datecr) AS query_hour,
                date_trunc('day'::text, a.datecr) AS query_day,
                date_trunc('week'::text, a.datecr) AS query_week,
                date_trunc('month'::text, a.datecr) AS query_month,
                a.queryid,
                pg_roles.rolname,
                pg_database.datname,
                a.toplevel,
                ...
                a.shared_blks_read::numeric * 8192::numeric AS shared_blks_read,
                a.local_blks_read::numeric * 8192::numeric AS local_blks_read,
                ...
                a.shared_blks_hit::numeric * 8192::numeric AS shared_blks_hit_size,
                a.local_blks_hit::numeric * 8192::numeric AS local_blks_hit_size,
            ...
            WHERE a.total_exec_time > 1
            ORDER BY a.datecr DESC;;
             """
        ),
    ]
