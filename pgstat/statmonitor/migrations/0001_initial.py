    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rows_per_query', models.BigIntegerField()),
                ('calls', models.BigIntegerField()),
                ('plans', models.BigIntegerField()),
                ('plan_time', models.FloatField(null=True)),
                ('exec_time', models.FloatField(null=True)),
                ('plan_time_per_query', models.FloatField(null=True)),
                ('exec_time_per_query', models.FloatField(null=True)),
                ('cache_hit', models.TextField()),
                ('cache_miss', models.TextField()),
                ('cache_hit_per_query', models.TextField()),
                ('cache_miss_per_query', models.TextField()),
                ('temp_bytes', models.TextField()),
                ('temp_bytes_written_per_query', models.TextField()),
                ('wal_bytes', models.DecimalField(decimal_places=0, max_digits=18, null=True)),
                ('wal_bytes_per_query', models.DecimalField(decimal_places=0, max_digits=18, null=True)),
            ],
            options={
